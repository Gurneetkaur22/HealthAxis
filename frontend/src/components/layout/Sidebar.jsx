...
import { HiOutlineViewGrid, HiOutlineUsers, HiOutlineUserGroup, HiOutlineCalendar, HiOutlineOfficeBuilding, HiOutlineCurrencyDollar, HiOutlineClipboardList, HiOutlineHome, HiOutlineUser, HiOutlineDocumentText, HiOutlinePlusCircle, HiOutlineKey, HiOutlineShieldCheck, HiOutlineMicrophone } from 'react-icons/hi';
...
const menuConfig = {
  admin: [
    ...
    { path: '/admin/fraud-detection', label: 'AI Fraud Detection', icon: HiOutlineShieldCheck },
  ],
  doctor: [
    ...
    { path: '/doctor/voice-emr', label: 'AI Voice EMR', icon: HiOutlineMicrophone },
  ],
  receptionist: [
